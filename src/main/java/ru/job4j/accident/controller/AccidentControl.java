...
public class AccidentControl {
    ...
    private final AccidentTypeRepository accidentTypeService;
    private final RuleRepository ruleService;

    public AccidentControl(AccidentRepository  accidentService, AccidentTypeRepository accidentTypeService, RuleRepository ruleService) {
